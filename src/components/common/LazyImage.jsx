...
const Skeleton = () => {
  return <div {...props} class="flex items-center justify-center h-48 shadow-box-soft relative">
...
const LazyImage = ({ src, ...props }) => {
  ...
  return <>
    <div ref={setImageContainer}>
      {!view() ? <Skeleton /> : null}
      <img ref={setImage} width={'100%'} {...props} class={view() ? 'block' : 'none'} onload={() => {
        setView(true)
      }} />
    </div>
  </>
